...
const features = [
  ...
  },
  {
    icon: "🍽️",
    title: "قائمة متنوعة",
    description: "اختر من بين مجموعة متنوعة من الأطباق الشهية والمشروبات",
  },
  {
    icon: "💳",
    title: "دفع آمن",
  ...
  },
  {
    icon: "🎁",
    title: "عروض حصرية",
    description: "استفد من العروض والخصومات الحصرية على طلباتك",
  },
  {
    icon: "📱",
    title: "تطبيق سهل",
  ...
  },
  {
    ...
    description: "شارك تجربتك معنا وتعرف على آراء العملاء الآخرين",
  },
];
