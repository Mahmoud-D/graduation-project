...
# 10. 🗃️ **Database Design for `order_items` Table**
...
### 2. ⚙️ **Operations on `order_items` Table**
...
- The relationship is **many-to-many**, managed via the **order_items** table
- The `order_items` table acts as a join table and stores additional data (like quantity)
